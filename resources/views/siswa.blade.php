                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="forms-sample">
                                                ...
                                                <div class="form-group">
                                                    <label>Jurusan</label>
                                                    <select ng-model="model.jurusan_id" ng-change="changeSelectedjurusan(model.jurusan_id)" class="form-control" ng-options="item.id as (item.nama+' ('+item.kode+') ') for item in dataJurusan"></select>
                                                </div>
                                                <div class="form-group">

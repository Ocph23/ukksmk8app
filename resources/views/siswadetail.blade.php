...
@section('content')
    <div ng-controller="siswaDetailController">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div style="display: flex; justify-content:space-between">
                                    ...
                                    <div>
                                        <button type="button" ng-click="updateSertifikat(siswa.sertifikat)"
                                            class="btn btn-inverse-primary btn-icon">
                                            <i class="mdi mdi-content-save-all"></i>
                                        </button>
                                        <button ng-if="canPrint()" type="button" ng-click="print()"
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input ng-model="siswa.sertifikat.instansi" type="text"
                                                        class="form-control" required> </td>
                                            </tr>
                                            <tr>
                                                <td>Ketua Penguji </td>
                                                <td><input ng-model="siswa.sertifikat.ketuapenguji" type="text"
                                                        class="form-control" required> </td>
                                            </tr>
                                            <tr>
                                                <td>Nomor Seri Sertifikat</td>
                                                <td><input ng-model="siswa.sertifikat.nomorseri" type="text"
                                                        class="form-control" required> </td>
                                            </tr>
                                            <tr>
                                                <td>Nomor Serifikat</td>
                                                <td><input ng-model="siswa.sertifikat.nomor" type="text"
                                                        class="form-control" required> </td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal Ditetapkan</td>
                                                <td><input type="date" ng-model="siswa.sertifikat.tanggalpenetapan"
                                                        type="text" class="form-control" required> </td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal Dicetak</td>
                                                <td><input type="date" ng-model="siswa.sertifikat.tanggalcetak"
                                                        type="text" class="form-control"> </td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal Ambil</td>
                                                <td><input type="date" ng-model="siswa.sertifikat.tanggalambil"
                                                        type="text" class="form-control"> </td>
                                            </tr>
                                            <tr>
                                                <td>Diambil Oleh</td>
                                                <td><input type="text8" ng-model="siswa.sertifikat.diambiloleh"
                                                        type="text" class="form-control"> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <tr ng-repeat="item in siswa.penilaian">
                                                ...
                                                <td ng-if="siswa.paket.basisnilai">
                                                    <input type="number" max="100"
                                                        ng-change="rata2Penilaian(siswa.penilaian)" class="form-control"
                                                        ng-model="item.nilai">
                                                </td>
                                                <td ng-if="!siswa.paket.basisnilai" style="text-align:center "> <input
                                                        style="font-size:12px" type="checkbox" ng-model="item.kompeten">
                                                </td>

                                            </tr>
                                            <tr style="background-color: #ebebeb" ng-if="siswa.paket.basisnilai">
                                                <td colspan="2"> Nilai Rata-Rata </td>
                                                <td style="width: 150px"> <input readonly type="number"
                                                        class="form-control" value="<% rata2.toFixed(2) %>"> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
        ...
        <!-- OLD TEMPLATE -->
        <div ng-if="siswa.tahunajaran.tahun < 2025" class="justprint">
            <div ng-if="siswa.penilaian" class="justprint"
                style="height:100vh; width: 100%; padding:90px; background-size:100% 100%; background-image:url('/assets/images/certificate2.jpg')">
                <div style="width: 100%; display: flex; align-items:center; justify-content:space-between">
                    ...
                    <div style="display:flex; justify-content:center; align-items: center; flex-direction:column">
                        ...
                        <h3 style="font-size: 18px;"><b style="color: #6696fc;">SMK NEGERI 8 TEKNOLOGI INFORMASI DAN
                                KOMUNIKASI
                                KOTA JAYAPURA</b></h3>
                    ...
                    <img ng-if="siswa.paket.eksternal.logo" style="width: 10%; height:30%"
                ...
                <div style=" display: flex; flex-direction:column">
                    ...
                    <div class="text-center">
                        <h3 class="font-italic" style="text-decoration: underline; line-height:15px"><b>SERTIFIKAT
                                KOMPETENSI</b></h3>
                    ...
                    <div style="display: flex; justify-content:space-between; padding:10px 80px">
                        <div style="display: flex; flex-direction:column">
                            ...
                            <label style="margin-top: 60px;"
                                class="font-weight-bold"><u><% siswa.tahunajaran.kepala_sekolah %></u></label>
                            <label style="line-height:2px">NIP. <% siswa.tahunajaran.nip %></label>
                        </div>

                        <div style="display: flex; flex-direction:column">
                            <label>Jayapura, <% penetapan(siswa.sertifikat.tanggalpenetapan) %></label>
                            <label style="line-height:2px">Ketua Tim Penguji</label>
                            <label style="margin-top: 60px;" class="font-weight-bold"><u>
                                    <%siswa.paket.eksternal.nama%></u></label>
            ...
            <div ng-if="siswa.penilaian" class="justprint"
                style="height:100vh; width: 100%; padding:100px 70px; background-size:100% 100%; background-image:url('/assets/images/certificate2.jpg')">
                ...
                <div style="display: flex; flex-direction:column">
                    <div style="padding:20px">
                        <h4 class="text-left mb-3"><b>Tugas : <% siswa.paket.kode %> - <% siswa.paket.judultugas %></b>
                        </h4>

        ...
        <div ng-if="siswa.penilaian" class="justprint"
            ...
            <div style="width: 100%; display: flex; align-items:center; justify-content:space-between">
                ...
                <div style="display:flex; justify-content:center; align-items: center; flex-direction:column">
                    ...
                    <h3 style="font-size: 18px;"><b style="color: #6696fc;">SMK NEGERI 8 TEKNOLOGI INFORMASI DAN KOMUNIKASI
                            KOTA JAYAPURA</b></h3>
            ...
            <div style=" display: flex; flex-direction:column">
                ...
                <div style="padding:10px 30px">
                    ...
                    <p class="mt-2">Dinyatakan <span class="font-italic"><b>LULUS</b></span> Uji Kompetensi Kejuruan dan
                ...
                <div style="display: flex; justify-content:space-between; padding:10px 80px">
                    <div style="display: flex; flex-direction:column">
                        ...
                        <label style="margin-top: 60px;" class="font-weight-bold"><u>Feronika Munthe, S.Pd. ,
                                M.Pd.</u></label>

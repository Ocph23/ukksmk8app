            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button ng-click="tambah()" type="button" class="btn btn-primary" data-toggle="modal"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr ng-repeat="item in data | orderBy:'-id'">
                                    <td><% $index+1 %></td>
                                    <td><% item.nama %></td>
                                    <td><% item.kepala_sekolah %> <br />
                                        NIP. <% item.nip %>
                                    </td>
                                    <td><% item.deskripsi %></td>
                                    <td>
                                        <i style="font-size: 20px; color:#b66dff" ng-if="!item.aktif"
                                            class="mdi mdi mdi-checkbox-blank-outline"></i>
                                        <i style="font-size: 20px;color:#b66dff" ng-if="item.aktif"
                                            class="mdi mdi mdi-checkbox-marked"></i>
                                    </td>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form class="forms-sample">
                                                    <div class="form-group">
                                                        ...
                                                        <input ng-model="model.tahun" type="number" class="form-control"
                                                            placeholder="Tahun Ajaran">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputUsername1">Nama Kepala Sekolah</label>
                                                        <input ng-model="model.kepala_sekolah" type="text"
                                                            class="form-control" placeholder="Nama Kepala Sekolah">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputUsername1">NIP Kepala Sekolah</label>
                                                        <input ng-model="model.nip" type="text" class="form-control"
